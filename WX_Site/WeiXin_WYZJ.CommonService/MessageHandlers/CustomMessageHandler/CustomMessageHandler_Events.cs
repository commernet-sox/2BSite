...
using WX_CommonService.Download;
using System;
...
namespace WX_CommonService.CustomMessageHandler
{
    ...
    public partial class CustomMessageHandler
    {
        private string GetWelcomeInfo()
        {
            ...
            if (Senparc.Weixin.Config.SenparcWeixinSetting.WeixinAppId == "wxaa7a2dce5b0333ba")//网赢之家
            {
                return @"网赢如意仓：行业领先的智能仓配网络运营商。
全国热线：400-855-7100
感谢您的关注，期待您的来电。我们与您，携手同行！"; 
            }
            else if (Senparc.Weixin.Config.SenparcWeixinSetting.WeixinAppId == "wx61a271df6cbd2f8e")//如意仓
            {
                return @"网赢如意仓：行业领先的智能仓配网络运营商。
全国热线：400-855-7100
感谢您的关注，期待您的来电。我们与您，携手同行！";
