...
{
    public class QuestionMenuService : BaseService<QuestionMenu, WXContext, QuestionMenuDTO, int>, IQuestionMenuService
    {
        ...
        public QuestionMenuService(IRepository<QuestionMenu, WXContext> Repository, IMapper mapper,
