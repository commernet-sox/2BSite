...
{
    public class HistoryService : BaseService<History, WXContext, HistoryDTO, int>, IHistoryService
    {
        ...
        public HistoryService(IRepository<History, WXContext> Repository, IMapper mapper,
